...
const Footer: React.FC = () => {
    ...
    const footerLinks = {
        ...
        学习资源: [
            ...
            { label: 'AI/机器学习', href: '/personal-programs/ai-ml' },
            { label: '算法竞赛', href: '/personal-programs/algorithms' },
            { label: '数据结构', href: '/personal-programs/data-structures' },
            { label: '在线课程', href: '/personal-programs/courses' },
        ],
        支持帮助: [
