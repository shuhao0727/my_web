...
```
docs/dev-logs/
├── ai-agent-merged.md          # AI智能体模块完整开发文档 (v2.8)
...
#### 部署规划
详细部署计划请参考 `DEPLOYMENT-PLAN.md`，包含：
- 单服务器部署架构
- Docker Compose配置示例
- Nginx反向代理配置
- SSL证书配置
...
**相关文档**:
- [部署规划文档](DEPLOYMENT-PLAN.md)
- [AI智能体开发文档](dev-logs/ai-agent-merged.md)
- [校本课系统开发文档](dev-logs/xbk-dev-log.md)
- [各模块开发日志](dev-logs/)
